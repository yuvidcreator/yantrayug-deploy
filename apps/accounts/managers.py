...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, username, email, mobile, first_name, last_name, password=None, **extra_fields):
        if email:
    ...
    def create_superuser(self, username, email, mobile, first_name, last_name, password=None, **extra_fields):
        ...
        user = self.create_user(username, email, mobile, first_name, last_name, password, **extra_fields)
        user.save(using=self._db)
        return user